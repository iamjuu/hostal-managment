      ...
      <main className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
            ...
            <span className="block text-indigo-600">Hostel Management</span>
          </h1>
              ...
              <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                <div className="relative">
                  ...
                  <p className="mt-2 ml-16 text-base text-gray-500">
                    Efficiently manage student registrations, room assignments, and personal information.
                  </p>
                </div>
                ...
                <div className="relative">
                  ...
                  <p className="mt-2 ml-16 text-base text-gray-500">
                    Keep track of all payments, dues, and financial transactions with ease.
                  </p>
                </div>
                ...
                <div className="relative">
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Room Management</p>
                  <p className="mt-2 ml-16 text-base text-gray-500">
                    Manage room allocations, availability, and maintenance schedules.
                  </p>
                </div>
                ...
                <div className="relative">
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Reports & Analytics</p>
                  <p className="mt-2 ml-16 text-base text-gray-500">
                    Generate detailed reports and gain insights into your hostel operations.
                  </p>
                </div>
              </div>
            </div>
